...
# Override identity from environment if provided at build-time
if(DEFINED ENV{MACOS_SIGNING_IDENTITY} AND NOT "$ENV{MACOS_SIGNING_IDENTITY}" STREQUAL "")
    set(SIGN_IDENTITY "$ENV{MACOS_SIGNING_IDENTITY}")
    message(STATUS "Using SIGN_IDENTITY from environment: ${SIGN_IDENTITY}")
endif()
